...
class MotherBoard(Producto):
    ...
    form_Factor = models.ForeignKey(FormFactor, on_delete=models.CASCADE, null=False, blank=False, verbose_name="Tamaño")
...
class GPU(Producto):
    ...
    mini_display_port = models.IntegerField(null=False, blank=False, default=10, verbose_name="Puertos MIni-DisplayPort")
    expansion_width = models.IntegerField(null=False, blank=False, default=10, verbose_name="Ancho del conector de expansión")
...
class Case(Producto):
    ...
    external_bays_5 = models.IntegerField(blank=False, null=False, default=0, verbose_name="Baías externas de 5.25 pulgadas")
    external_bays_3 = models.IntegerField(blank=False, null=False, default=0, verbose_name="Baías externas de 3.5 pulgadas")
    internal_bays_3 = models.IntegerField(blank=False, null=False, default=0, verbose_name="Baías internas de 3.5 pulgadas")
    internal_bays_2 = models.IntegerField(blank=False, null=False, default=0, verbose_name="Baías internas de 2.5 pulgadas")
    full_h_expansion_slot = models.IntegerField(blank=False, null=False, default=0, verbose_name="Conectores de expansión de tamaño completo")
    half_h_expansion_slot = models.IntegerField(blank=False, null=False, default=0, verbose_name="Conectores de expansión de tamaño medio")
...
class CaseFan(Producto):
    ...
    connector = models.ForeignKey(Connector, on_delete=models.CASCADE, null=False, blank=False, verbose_name="Tipo de conector")
    controller = models.ForeignKey(Controller, on_delete=models.CASCADE, null=False, blank=False, verbose_name="Tipo de controlador")